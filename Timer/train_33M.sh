...
#SBATCH--job-name=33M-normal-OpenLTM

# Echo time and hostname into log
echo "Date:     $(date)"
echo "Hostname: $(hostname)"
echo "Starting training for 33M OpenLTM model"
...
cd /network/scratch/s/senthils/CS_project/OpenLTM
export WANDB_RESUME=never
unset WANDB_RUN_ID
bash ./scripts/pretrain/timer_utsd_4.sh